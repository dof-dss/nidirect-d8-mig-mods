...
namespace Drupal\migrate_nidirect_driving_instructor\Test\Kernel;
...
/**
 * Tests Driving instructor migrations.
 *
 * @group node
 */
class DrivingInstructorMigrateTest extends EntityKernelTestBase {
